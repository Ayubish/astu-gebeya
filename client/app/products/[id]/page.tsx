    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <div className="bg-gradient-to-r from-primary via-primary to-primary/80">
        <div className="container mx-auto px-4 py-4">
          <Link
            href="/"
            className="flex items-center gap-2 text-white hover:text-white/80 w-fit">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="bg-card border border-border rounded-lg p-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Seller since January 2023 • 98% positive rating
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed">
                {product.description ??
                  "High-quality condition product. Excellent performance and all features working perfectly. Comes with original packaging and accessories. No defects or issues."}
              </p>
            </div>
          </div>
        </div>
